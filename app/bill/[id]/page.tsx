            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-6 mb-6">
              <div className="flex-1 w-full">
                <div className="flex items-center gap-3 mb-3 flex-wrap">
                  <span className="px-3 py-1 bg-slate-800 text-white rounded-full text-sm font-semibold">
              ...
              <div className="flex flex-col gap-2 w-full lg:w-auto">
                  ...
                  className="px-4 py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-800 transition-colors text-center text-sm font-medium"
                >
                  View on LegiScan
                </a>
